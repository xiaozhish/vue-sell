...
<script>
  ...
  export default {
    ...
    created() {
      this.$http.get(appConfig.sellUrl + '/buyer/order/detail', {
        params: {
    ...
    methods: {
      cancelOrder: function (orderId) {
        ...
        this.$http.post(appConfig.sellUrl + '/buyer/order/cancel', {
          orderId: orderId,
          openid: getCookie('openid')
        }).then(function (response) {
      ...
      pay: function (orderId) {
        location.href = appConfig.wechatPayUrl +
          '?openid=' + getCookie('openid') +
          '&orderId=' + orderId +
          '&returnUrl=' + encodeURIComponent(appConfig.sellUrl + '/#/order/' + orderId);
      }
    }
  };
